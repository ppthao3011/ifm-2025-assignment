...
def show_cover_page():
    ...
    <div class="content-section overview-section">
        ...
        <div style="margin-top: 20px; color: #1565C0; line-height: 1.8; font-size: 18px;">
            ...
            <p>Chúng em ý thức rằng bài phân tích vẫn còn nhiều thiếu sót do hạn chế về học thuật kết hợp với kiến thức kinh tế tài chính vĩ mô, và mong cô thông cảm. Dù vậy, nhóm em hy vọng rằng bài viết này sẽ giúp ích được phần nào cho những người mới bắt đầu đầu tư.</p>
